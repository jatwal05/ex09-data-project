...
### My Analysis
I analyzed how a student's major impacts their experience in COMP110. Since most students are non-majors, I wanted to see if they find the material more difficult or have lower average understanding. This helps determine if we need targeted review sessions to support beginners from all departments.
...
Refinements/Extensions: Instead of just calling them "Non-Major Reviews," it might be better to brand them as "Zero-Experience Bootcamps" or "Beginner Basics." That way, it targets the actual root of the problem which is the lack of prior experience rather than just what their major is.
